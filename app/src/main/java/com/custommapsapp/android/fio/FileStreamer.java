package com.custommapsapp.android.fio;
...
public class FileStreamer {
    ...
    public void addRecord(final String writerId, final String msg) throws IOException, KeyException {
    ...
    public void endFile(String writerId) throws IOException {
        // execute the block with only one thread
        synchronized (this) {
            BufferedWriter writer = getFileWriter(writerId);
            writer.flush();
            writer.close();
            mFileWriters.remove(writerId);
        }
    }
